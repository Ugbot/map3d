...
// Pure functions, no state, safe in workers and main thread.

export const EARTH_RADIUS_M = 6378137;
export const EARTH_CIRCUMFERENCE_M = 2 * Math.PI * EARTH_RADIUS_M;
export const ORIGIN_SHIFT = EARTH_CIRCUMFERENCE_M / 2; // ~20037508.342789244
...
// Slippy tile (XYZ) origin is at the NW corner; y grows southward.
...
// Returns the tile's bounding box in Web Mercator meters.
...
// Decode a tile-local MVT coord (0..extent) into Web Mercator meters.
// extent is usually 4096.
export function tileLocalToMeters(
  ...
  // MVT y origin is top-left of the tile, so flip.
